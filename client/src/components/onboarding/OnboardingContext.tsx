...
const ONBOARDING_CONTENT: Record<OnboardingStep, OnboardingStepContent> = {
  ...
  'security-monitoring': {
    ...
    message: "InfraAudit automatically scans for security configuration drifts and compliance issues in your infrastructure. We check against industry best practices and standards like CIS, HIPAA, and PCI DSS.",
  ...
  'slack-integration': {
    ...
    message: "Connect InfraAudit to your Slack workspace to receive real-time alerts and reports. You can customize which alerts go to specific channels for targeted notifications.",
    mascotExpression: 'happy',
    position: 'right',
    routePath: '/settings',
  },
  'settings-customization': {
    ...
    message: "Visit the Settings page to customize your dashboard, notification preferences, and alert thresholds. You can tailor InfraAudit to your specific needs.",
    mascotExpression: 'thinking',
    position: 'bottom',
    routePath: '/settings',
  },
  'ai-insights': {
    ...
    message: "InfraAudit uses advanced AI to provide personalized recommendations and insights. Our AI continuously learns from your infrastructure to provide more accurate suggestions over time.",
    mascotExpression: 'happy',
    position: 'center',
    routePath: '/',
  },
  'completed': {
    title: 'All Set!',
    message: "Great job! You're now ready to start monitoring your cloud infrastructure with InfraAudit. I'll be here if you need help - just click the cloud icon in the bottom right corner.",
    mascotExpression: 'happy',
    position: 'center',
  },
};
