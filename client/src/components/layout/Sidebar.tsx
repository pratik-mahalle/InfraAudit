...
const navSections: NavSection[] = [
    {
        ...
        items: [
            ...
            { label: "Recommendations", href: "/cost", icon: Target, badge: "3", badgeColor: "bg-emerald-500" },
    ...
    },
    {
        ...
        items: [
            ...
            { label: "Drift Detection", href: "/security", icon: AlertTriangle, badge: "2", badgeColor: "bg-amber-500" },
